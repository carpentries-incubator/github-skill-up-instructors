...
When looking at the rendered "instructor view" to prepare to teach, we can review all images that are part of the lesson to see how we want to reuse them.
When preparing we notice that the the 2nd image cinnamon rolls doesn't have any alternative text.
...
You aren't expected to memorize all of the syntax but instead can look it up in the [Workbench Documentation][workbench].
